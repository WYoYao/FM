var cardPrintController = {
    ...
    /*获取专业-系统-类型
    */
   getyDomainSystemEquipArr: function (paramObj, successCall, errCall, completeCall) {
    this.sendAjax('restDictService/queryDomainSystemEquipType', paramObj, successCall, errCall, completeCall);
    },
