    ...
    */
    setEqGridHeight: function () {
        Vue.nextTick(function () {
            //此处写设置高的代码
            var heightA = $($(".printCardConA")[0]).height();
            var heightAA = $("#downEquipmentWrap .printCardCon_pageA").height();

            var heightBB = $("#downSpaceWrap .printCardCon_pageA").height();  
            $("#gridCardPrintForEq").height(heightA - heightAA - 116);       
            $("#downSpaceWrap").height(heightA - heightBB - 116);
        });
    },
    /*设置空间名片页面表格的高
