...
function editSelClick(event) {
    var value=$("#txtMerchantNameEdit").pval();
    $("#txtMerchantNameEdit").precover();
    $("#txtMerchantNameEdit").pval(value);


    $("#txtMerchantNameEdit").attr("verify","true");
...
//确定
function editConfirm(event, isInsure,flag) {
