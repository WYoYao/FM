...
var headerbCall = function () {
    ...
    if (v.instance.baseTab == 1) {
        v.instance.$nextTick(function () {
            //设备详情页--技术参数
            $(".detail2_contentView:visible")[0].addEventListener('scroll', function () {
                v.instance.onScrollPub(".detail2_contentView", ".detail2_verticalView", ".detail2_verticalView", ".infos", v.instance.EquipDynamicInfo)
            });
        })
    }
}
...
var addid_manufacturer_sel = function (item) {
    v.instance.equip_models = item.equip_models.map(function (name) {
